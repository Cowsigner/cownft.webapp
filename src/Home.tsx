...
const metadataTitle = process.env.REACT_APP_METADATA_TITLE!.toString();
const metadataSymbol = process.env.REACT_APP_METADATA_SYMBOL!.toString();
const metadataUri = process.env.REACT_APP_METADATA_URI!.toString();
